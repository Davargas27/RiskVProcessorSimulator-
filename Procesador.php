...
<h1 align="center">Simulador Procesador</h1>
<p align="center">Karen Daniela Vargas Casas y Felipe Galindo Diaz</p><br/>


<div class="row">
    <div class="col-sm-3">
        <h5>Digita el codigo o set de instrucciones que deseas ejecutar</h5>
        <textarea name="codearea" id="codearea" rows="10" cols="50"></textarea>
